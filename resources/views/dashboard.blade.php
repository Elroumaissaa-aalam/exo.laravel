            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="space-x-4">
                        ...
                        <a href="{{ route('cart.index') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Mon panier</a>
                        <a href="{{ route('orders.index') }}" class="bg-purple-500 text-white px-4 py-2 rounded">Mes commandes</a>
                    </div>
                    <a href="{{ route('cart.add') }}">go add prodacte</a>
